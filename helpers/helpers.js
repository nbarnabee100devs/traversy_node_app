module.exports = {
  truncate: function (str, len) {
    if (str.length > len && str.length > 0) {
      ...
      new_str = str.substr(0, new_str.lastIndexOf(" ")); // Ends the string on a space, thus eliminating any words that got cut off
  ...
  stripTags: function (input) {
    // Ughhh regex, but this will catch anything that's contained in angle brackets
